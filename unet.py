...
class Unet(Model):
  ...
  def call(self, x):
    ...
    merge7 = tf.keras.layers.concatenate([conv6,up7], axis = 3)
    conv13 = self.conv11(merge7)
    ...
    merge9 = tf.keras.layers.concatenate([conv2,up9], axis = 3)
    conv15 = self.conv11(merge9)
    conv16 = self.conv12(conv15)
